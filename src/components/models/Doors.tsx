    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <group
          ...
          onPointerLeave={handleHoverLeave}
          onClick={() => {
            if (floor === 3) moveAnimation(3.4, -2.5, 3.1, 3.6, Math.PI * 1.7);
          }}
        >
          <group
            name="Plane017_1"
        ...
        <group
          ...
          onPointerLeave={handleHoverLeave}
          onClick={() => {
            if (floor === 3) moveAnimation(4.3, -5.1, 3.2, 0.6, Math.PI * 1.7);
          }}
        >
          <group
            name="Plane017_2"
        ...
        <group
          ...
          onPointerLeave={handleHoverLeave}
          onClick={(e) => {
            if (floor === 3) moveAnimation(e.point.x + 1, e.point.z, 2);
          }}
        >
          <group
            name="Plane017_3"
        ...
        <group
          ...
          onPointerLeave={handleHoverLeave}
          onClick={() => {
            if (floor === 3) moveAnimation(-59.3, 13.2, 7, 5, 5.67);
          }}
        >
          <group
            name="Plane017_5"
        ...
        <group
          ...
          onPointerLeave={handleHoverLeave}
          onClick={(e) => {
            if (floor === 3) moveAnimation(e.point.x, e.point.z - 1, 4);
          }}
        >
          <group
            name="Plane017_6"
        ...
        <group
          ...
          onPointerLeave={handleHoverLeave}
          onClick={(e) => {
            if (floor === 5) moveAnimation(e.point.x - 2, e.point.z, 5.1);
          }}
        >
          <group
            name="Plane015_2"
        ...
        <group
          ...
          onPointerLeave={handleHoverLeave}
          onClick={(e) => {
            if (floor === 5.1) moveAnimation(e.point.x + 2, e.point.z, 5);
          }}
        >
          <group
            name="Plane017_7"
        ...
        <group
          ...
          onPointerLeave={handleHoverLeave}
          onClick={(e) => {
            if (floor === 5) moveAnimation(e.point.x, e.point.z - 1, 3);
          }}
        >
          <group
            name="Plane015_3"
        ...
        <group
          ...
          onPointerLeave={handleHoverLeave}
          onClick={() => {
            if (floor === 3) moveAnimation(2.2, 14.2, 5, 3.3, 2.04);
          }}
        >
          <group
            name="Plane015_3"
        ...
        <group
          ...
          onPointerLeave={handleHoverLeave}
          onClick={() => {
            if (floor === 4) moveAnimation(-59.3, 13.2, 7, 5, 5.67);
          }}
        >
          <group
            name="Plane017_8"
        ...
        <group
          ...
          onPointerLeave={handleHoverLeave}
          onClick={(e) => {
            if (floor === 4) moveAnimation(e.point.x, e.point.z + 1, 3);
          }}
        >
          <group
            name="Plane017_11"
        ...
        <group
          ...
          onPointerLeave={handleHoverLeave}
          onClick={() => {
            if (floor === 2) moveAnimation(0.1, 1.7, 3, 1.7, Math.PI * 0.7);
          }}
        >
          <group
            name="Plane015_6"
        ...
        <group
          ...
          onPointerLeave={handleHoverLeave}
          onClick={() => {
            if (floor === 2) moveAnimation(19, 0.7, 1.1, 4, -0.36);
          }}
        >
          <group
            name="Plane017_12"
        ...
        <group
          ...
          onPointerLeave={handleHoverLeave}
          onClick={(e) => {
            if (floor === 2) moveAnimation(e.point.x + 1, e.point.z);
          }}
        >
          <group
            name="Plane017_13"
